...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("./classifications_all_in_one.txt", np.float32)  #kullanıcı girdilerinden oluşan sınıflandırma verilerini oku.
    ...
    try:
        npaFlattenedImages = np.loadtxt("./flattened_images_all_in_one.txt", np.float32) # txt dosyasındaki resim verilerini oku.
